    ...
    <div class="row">
        ...
        <div class="col-sm-9">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            ...
                            <img src="<?php echo BASE_URL; ?>assets/img/anuncios/<?php echo $anuncio['url']; ?>" border="0" height="75">
                            <?php else: ?>
                            <img src="<?php echo BASE_URL; ?>assets/img/default.png" height="75" border="0">
                            <?php endif; ?>
                        </td>
                        <td>
                            <a href="<?php echo BASE_URL; ?>produto/abrir/<?php echo $anuncio['id']; ?>"><?php echo utf8_encode($anuncio['titulo']); ?></a><br>
            ...
            <ul class="pagination">
                ...
                <li class="<?php echo $page == $i ? 'active' : ''; ?>"><a href="<?php echo BASE_URL; ?>?<?php $w = $_GET; $w['p'] = $i; echo http_build_query($w); ?>"><?php echo $i; ?></a></li>
                <?php endfor; ?>
            </ul>
        </div>
    </div>
